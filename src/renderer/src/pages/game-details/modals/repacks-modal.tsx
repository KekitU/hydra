...
import { Badge, Button, Modal, TextField, Link } from "@renderer/components";
          ...
          {filteredRepacks.map((repack) => {
            ...
            return (
              ...
              >
                ...
                <div className={styles.repackContent}>
